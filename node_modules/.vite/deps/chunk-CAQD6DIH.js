...
function mark_reactions(signal, status) {
  ...
  for (var i = 0; i < length; i++) {
    ...
    if (false_default && (flags & INSPECT_EFFECT) !== 0) {
...
function handle_error(error, effect2, previous_effect, component_context2) {
  ...
  if (!false_default || component_context2 === null || !(error instanceof Error) || handled_errors.has(error)) {
  ...
  return new Proxy(
    ...
    value,
    {
      ...
      get(target, prop, receiver) {
        var _a2;
        if (false_default && prop === STATE_SYMBOL_METADATA) {
          return metadata;
        }
...
//# sourceMappingURL=chunk-CAQD6DIH.js.map
